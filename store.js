...
function ready () {
    ...
    for(var i = 0; i < removeCartItemButtons.length; i++) {
        ...
        input.addEventListener('change', quantityChangd)
    }
...
function addItemToCart(title,price,imageSrc) {
    ...
    cartRow.getElementsByClassName('cart-quantity-input')[0].addEventListener('click',quantityChangd)
}
